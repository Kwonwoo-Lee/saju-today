...
const TEXT_FIELDS = [
  ...
  ["hint-horoscope-date", "hintHoroscopeDate"], ["horoscope-submit-btn-label", "horoscopeSubmitBtn"],
  ...
  ["horoscope-result-title", "resultTitleHoroscope"], ["tab-horoscope-btn", "resultTitleHoroscope"],
  ...
  ["footer-nav-horoscope", "navHoroscope"], ["footer-nav-analysis", "navAnalysis"], ["footer-nav-year", "navYear"], ["footer-nav-compat", "navCompat"],
...
const ATTR_FIELDS = [
  ...
  ["horoscope-name", "placeholder", "placeholderName"],
